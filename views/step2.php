...
<article class="uk-article">
    ...
    <form id="step2" class="uk-form" action="{{ baseUrl }}step2" method="POST">
        <div class="uk-grid">
            ...
            <div class="uk-width-1-2 notes"><span class="uk-badge uk-badge-danger">Required</span> Required field. SKU number</div>
            <hr class="table-row">
			...
			<div class="uk-width-1-2 notes"><span class="uk-badge uk-badge-notification uk-badge-warning">v6</span> Needed in ver. 6</div>
            <hr class="table-row">
